...
// This the normal uart config, 8bit, no parity, 1 stop bit,
// the more setting read the U1UCR register, in datasheet
#define     UART1_8N1                           (U1UCR_STOP) // 8bit, no parity, 1 stop bit

#define     UART1_PIN_ALT0                      0
#define     UART1_PIN_ALT1                      1
/**
 * 
 * @brief uart1 config
 *
 * @param baudrate setting, in the hal_uart1, you can see the options
 * @param option about UXUCR Register setting, include parity, stop bit, data length, etc.
